...
public class ItemRegist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verifyStoragePermissions(ItemRegist.this);
...
//                String iprice = price.getText().toString();
                ...
                task.execute("http://" + IP_ADDRESS + "/insert_i.php", ipic, iname, iid, istprice, itype, istate, iintro);
                ...
                Log.d(TAG, "testdata - " + ipic + iname + iid + istprice +  itype + istate + iintro);
                dialog = ProgressDialog.show(ItemRegist.this, "", "Uploading file...", true);
            ...
            try {
                ...
                if (serverResponseCode == 200) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(ItemRegist.this, "File Upload Complete.",
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(ItemRegist.this, "MalformedURLException",
                                Toast.LENGTH_SHORT).show();
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(ItemRegist.this, "Got Exception : see logcat ",
                                Toast.LENGTH_SHORT).show();
