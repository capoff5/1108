...
//            }
    ...
    @Override
    public MyOItemsAdapter.CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.bid_list_view, null);

        CustomViewHolder viewHolder = new MyOItemsAdapter.CustomViewHolder(view);
